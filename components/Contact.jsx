    ...
    <>
      <section className="post-list post-content over-scroll-bottom">
        <div className="post-data">
          ...
          <p> Currently am working on personal projects, and a few freelance gigs. Feel free to reach me
            for any inquiries, and projects at my <a href={`mailto:${emailAcc}`}> <b>email</b> </a>
            and <a href={`tell:+${antiContact}`}> <b>phone no</b></a>
            <br />
            <br />
            <span>
                            {`${feedBack}`}
